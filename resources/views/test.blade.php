    ...
    <section style="padding: 64px 0px;">
        <div class="container">
            <div class="row row-col">
                ...
                <div class="col-md-7 col-sm-6 text-center mb-xs-24"><img class="img-responsive" style="max-width: 560px;" src="/img/t1-mac2.jpg"></div>
            </div>
        </div>
    </section>
...
<div class="general-content">
    ...
    <div class="bullets-div">
        <div class="content center bullets">
            ...
            <div class="col span1of3 mid-span3of4 small-span1of1 align-left">
                <h2 class="heading center">Share your work</h2>
                <p>Your readers care what you have to say. Email them updates from your world. Give them behind-the-scenes peeks at your projects and process, or show them your published work. Point them to things you’re reading, watching, and listening to.</p>
            </div>
            <div class="col span1of3 mid-span3of4 small-span1of1 align-left">
                <h2 class="heading center">Keep it simple</h2>
                <p>TinyLetter offers a clean and straightforward writing experience for people who aren’t looking for advanced reporting or features for businesses. Use our editor or send directly from your own email client. And all for free.</p>
            </div>
        </div>
    </div>
</div>
                ...
                <div class="card mb-5 mb-lg-0">
                    <div class="card-body">
                        ...
                        <ul class="fa-ul text-secondary">
                            ...
                            <li><span class="fa-li"><i class="fa fa-check"></i></span>One Project</li>
            ...
            <div class="col-lg-4">
                <div class="card mb-5 mb-lg-0">
                    <div class="card-body">
                        ...
                        <hr>
                        <ul class="fa-ul">
                            <li><span class="fa-li"><i class="fa fa-check"></i></span>Five Users</li>
                            <li><span class="fa-li"><i class="fa fa-check"></i></span>10GB Storage</li>
                            <li><span class="fa-li"><i class="fa fa-check"></i></span>Five Projects</li>
                            <li><span class="fa-li"><i class="fa fa-check"></i></span>Community Access</li>
                            <li><span class="fa-li"><i class="fa fa-check"></i></span>Online support</li>
                        </ul>
                        <a href="#" class="btn btn-block btn-primary btn-lg">Get Plan</a>
                    </div>
                </div>
            ...
            <div class="col-lg-4">
                <div class="card mb-5 mb-lg-0">
                    <div class="card-body">
                        ...
                        <hr>
                        <ul class="fa-ul">
                            <li><span class="fa-li"><i class="fa fa-check"></i></span>Unlimited Users</li>
                            <li><span class="fa-li"><i class="fa fa-check"></i></span>Unlimited Storage</li>
                            <li><span class="fa-li"><i class="fa fa-check"></i></span>Unlimited Projects</li>
                            <li><span class="fa-li"><i class="fa fa-check"></i></span>Community Access</li>
                            <li><span class="fa-li"><i class="fa fa-check"></i></span>Online support</li>
                            <li><span class="fa-li"><i class="fa fa-check"></i></span>24/7 skype call</li>
                        </ul>
                        <a href="#" class="btn btn-block btn-primary btn-lg">Get Plan</a>
                    </div>
                </div>
...
<div class="container">
    ...
    <div class="col-lg-3 col-md-4 col-6">
        <a class="d-block mb-4 h-100 pop">
            <img class="img-fluid img-thumbnail" style="width: 210px; max-height: 160px;" src="https://source.unsplash.com/pWkk7iiCoDM/400x300" alt="">
            </a>
    </div>
    <div class="col-lg-3 col-md-4 col-6">
        <a class="d-block mb-4 h-100 pop">
