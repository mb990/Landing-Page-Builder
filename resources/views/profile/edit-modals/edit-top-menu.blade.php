<div class="js-top-menu">
    ...
    <span class="js-project-top-menu-link js-link-1 d-none">
        <input name="title-1" type="text" placeholder="Link title">
        <input type="text" name="link-url-1" placeholder="Link URL">
    </span>
    <span class="js-project-top-menu-link js-link-2 d-none">
            <input name="title-2" type="text" placeholder="Link title">
            <input type="text" name="link-url-2" placeholder="Link URL">
        </span>
    <span class="js-project-top-menu-link js-link-3 d-none">
        <input name="title-3" type="text" placeholder="Link title">
        <input type="text" name="link-url-3" placeholder="Link URL">
    </span>
    <span class="js-project-top-menu-link js-link-4 d-none">
        <input name="title-4" type="text" placeholder="Link title">
        <input type="text" name="link-url-4" placeholder="Link URL">
    </span>
</div>
