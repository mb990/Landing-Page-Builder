        ...
        <main>
            <aside class="profile-aside">
                <div class="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                    ...
                    <a class="nav-link" id="v-pills-settings-tab" data-toggle="pill" href="#v-pills-settings" role="tab" aria-controls="v-pills-settings" aria-selected="false">New project</a>
                </div>
            </aside>
                ...
                <div class="tab-content" id="v-pills-tabContent">
                    <div class="tab-pane fade show active" id="v-pills-home" role="tabpanel" aria-labelledby="v-pills-home-tab">
                        <div class="card-columns">
                            ...
                            <div class="card">
                                <img class="card-img-top" src="https://source.unsplash.com/EMSDtjVHdQ8/100px160/" alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title">Template2</h5>
                                    <a href="#" class="btn btn-primary">Go somewhere</a>                                </div>
                            </div>
                            <div class="card">
                                <img class="card-img-top" src="https://source.unsplash.com/G9Rfc1qccH4/100px160/" alt="Card image cap">
                                <div class="card-body">
                                    <h5 class="card-title">Template3</h5>
                                    <a href="#" class="btn btn-primary">Go somewhere</a>                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="tab-pane fade" id="v-pills-settings" role="tabpanel" aria-labelledby="v-pills-settings-tab">Ovde ide novi pojekat</div>
                </div>
            </div>
        </main>
        <script>
