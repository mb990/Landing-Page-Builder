...
<body class="body-t2">
    ...
    <section class="hero" id="page-top">
        <div class="hero-image">
            <img class="hero-background-t2" src="/img/bgd2.jpg">
            <div class="hero-text-t2">
                <h1 class="text-white">Explore Belgrade</h1>
        ...
        <div class="bullets-div-t2">
            <div class="content center">
                <div class="col span1of3 mid-span3of4 small-span1of1 align-left">
                    <p><strong style="font-size: 24px;">Clock-making industry</strong>, is even older than the world-famous Swiss one.
                        The Serbs had their own clock at least 200 years before the Swiss did.</p>
                </div>
                <div class="col span1of3 mid-span3of4 small-span1of1 align-left">
                    <p><strong style="font-size: 24px;">Hospitality</strong>,
...
<section class="team-section text-center my-5 width-limit" id="visitors">
    ...
    <div class="row text-center" style="max-width: 100%; padding: 20px;">
        <!--Grid column-->
        <div class="col-md-4 mb-md-0 mb-5" style="padding: 0px;">
            <div class="testimonial">
                <div class="col-md-6 avatar mx-auto">
                ...
                <p class="font-weight-normal dark-grey-text">
                    <i class="fa fa-quote-right"></i>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Quod
        ...
        <div class="col-md-4 mb-md-0 mb-5" style="padding: 0px;">
            <div class="testimonial">
                ...
                <p class="font-weight-normal dark-grey-text">
                    <i class="fa fa-quote-right"></i>Ut enim ad minima veniam, quis nostrum exercitationem ullam
        ...
        <div class="col-md-4 mb-md-0 mb-5" style="padding: 0px;">
            <div class="testimonial">
                <div class="col-md-6 avatar mx-auto">
                    <img src="https://mdbootstrap.com/img/Photos/Avatars/img%20(10).jpg" style="margin: auto;" class="rounded-circle img-fluid"/>
                </div>
                <h4 class="font-weight-bold dark-grey-text mt-4">Maria Kate</h4>
                <h6 class="font-weight-bold blue-text my-3">Photographer</h6>
                <p class="font-weight-normal dark-grey-text">
                    <i class="fa fa-quote-right"></i>At vero eos et accusamus et iusto odio dignissimos ducimus qui
    ...
    <div class="container">
        ...
        <div class='package'>
            ...
            <ul>
                ...
                <a class="btn btn-warning" type="button">Get this</a>
